# filepath: f:\X_code\Projects\25_summer_python\py_game_Kaleidoscope\history_manager.py
"""
...
class ModifyShapeAction(Action):
    ...
    def undo(self):
        for attr, value in self.old_attrs.items():
            setattr(self.shape, attr, value)
...
class AddPixelAction(Action):
    ...
    def execute(self):
        self.draw_func(self.layer, self.path)

    def undo(self):
        # Implement undo logic for pixel actions if necessary
        pass